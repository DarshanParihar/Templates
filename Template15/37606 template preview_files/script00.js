...
$(function(){
	...
	$('.list-1 li').prepend('<span></span><span></span>').find('>a').append('<span></span>').hover(function(){$(this).animate({color:'#000'},{queue:false}).find('>span').animate({opacity:1},{queue:false}).parent().parent().find('>span:first').stop().animate({opacity:0},{queue:false}).next().stop().animate({opacity:1},{queue:false})},function(){$(this).animate({color:'#858585'},{queue:false}).find('>span').animate({opacity:0},{queue:false}).parent().parent().find('>span:first').stop().animate({opacity:1},{queue:false}).next().stop().animate({opacity:0},{queue:false})})
